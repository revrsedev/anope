 ...
 * rpc_chanstatsplus
 *
 * Exposes the SQL-backed statistics generated by the third-party
 * chanstats_plus module via Anope's RPC framework (jsonrpc/xmlrpc).
 *
 * This module adds RPC methods under the "anope.chanstatsplus.*" prefix
 * for querying per-channel, per-nick, and leaderboard-style stats.
 *
